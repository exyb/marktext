const COMMANDS = Object.freeze({
  ...
  VIEW_SIDE_BY_SIDE_MODE: 'view.side-by-side-mode',
  VIEW_TOGGLE_SIDE_BY_SIDE_SOURCE_LEFT: 'view.toggle-side-by-side-source-left',
  ...
  VIEW_TOGGLE_RIGHT_TOC: 'view.toggle-right-toc',
